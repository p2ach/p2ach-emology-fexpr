...
class ToolOptions():
    ...
    def initialize(self, parser):
        ...
        # parser.add_argument('--model_path', type=str, default="./model_save/fc7_best_model.pth", help='the path of pretrained model')
        parser.add_argument('--model_path', type=str, default="./model_save/fc7_3446.pth", help='the path of pretrained model')
        # parser.add_argument('--model_path', type=str, default=None, help='the path of pretrained model')
        # parser.add_argument('--model_path', type=str, default=None, help='the path of pretrained model')
        parser.add_argument('--landmark_num', type=int, default=478, help='the number of landmarks')
        parser.add_argument('--chns', type=int, default=3, help='the number of chnnels')
        parser.add_argument('--label_emotion', type=list, default=["Neutral","Happy","Sad","Angry","Surprised","Scared","Disgusted"], help='the number of chnnels')
        parser.add_argument('--image_width', type=int, default=48, help='the width of input image')
        parser.add_argument('--batch_size', type=int, default=4090, help='the batch size of training')
        parser.add_argument('--num_workers', type=int, default=1, help='the number of workers')
        parser.add_argument('--start_lr', type=float, default=1e-4, help='the learning rate of start training')
        ...
        parser.add_argument('--total_epoch', type=int, default=5000, help='the number of total epoch')
        ...
        parser.add_argument('--train_path', type=str, default="/docker/users/ldy/data/fexpr/dest/train/", help='the path of images for training')
        parser.add_argument('--validation_path', type=str, default='/docker/users/ldy/data/fexpr/dest/val/', help='the path of labels for training')
