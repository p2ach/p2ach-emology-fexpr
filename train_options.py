...
class ToolOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--batch_size', type=int, default=1024, help='the batch size of training')
        parser.add_argument('--num_workers', type=int, default=1, help='the number of workers')
        parser.add_argument('--start_lr', type=float, default=5e-3, help='the learning rate of start training')
        ...
        parser.add_argument('--train_path', type=str, default="/home/doy/dataset/fexpr/dest/train/", help='the path of images for training')
        parser.add_argument('--validation_path', type=str, default='/home/doy/dataset/fexpr/dest/val/', help='the path of labels for training')
